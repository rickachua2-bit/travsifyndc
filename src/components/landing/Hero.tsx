        ...
        <div>
          ...
          <div className="animate-fade-in-up delay-500 mt-8 grid grid-cols-2 gap-2 sm:grid-cols-3">
            {[
              ...
              <div
                key={c.label}
                className="inline-flex items-center gap-2 rounded-lg border border-border bg-white/70 px-3 py-2 text-xs font-medium text-primary backdrop-blur"
              >
        ...
        <div className="relative animate-scale-in delay-200">
          ...
          <div className="relative mx-auto aspect-square w-full max-w-[480px]">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <div
                className="relative flex h-32 w-32 items-center justify-center rounded-2xl bg-white shadow-elevated"
              ...
              >
                ...
                <div className="relative text-center">
                  ...
                  <div className="mt-1 inline-flex items-center gap-1 rounded-full bg-white/20 px-1.5 py-0.5 text-[8px] font-semibold text-white">
            ...
            {verticals.map((v, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="hover-lift flex w-[120px] items-center gap-2 rounded-xl border border-border bg-white p-2.5 shadow-soft" style={{ boxShadow: "var(--shadow-soft)" }}>
                      ...
                      <div className="min-w-0">
                        <div className="font-display text-xs font-bold leading-tight text-primary">{v.label}</div>
            ...
            <div className="pointer-events-none absolute -bottom-2 left-1/2 w-[110%] -translate-x-1/2 overflow-hidden rounded-xl border border-border bg-primary/95 py-2 backdrop-blur">
          ...
          <div className="absolute -left-2 top-2 hidden animate-float rounded-xl border border-border bg-white px-3 py-2 shadow-soft md:block" style={{ boxShadow: "var(--shadow-soft)" }}>
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white">
                <Wallet className="h-4 w-4" />
              </div>
              <div>
                <div className="font-display text-[11px] font-bold text-primary">Local payments</div>
          ...
          <div className="absolute -right-2 top-12 hidden animate-float delay-300 rounded-xl border border-border bg-white px-3 py-2 shadow-soft md:block" style={{ boxShadow: "var(--shadow-soft)" }}>
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-display text-[11px] font-bold text-primary">+12% markup</div>
